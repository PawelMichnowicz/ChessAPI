        ...
        if message == "give up":
            ...
            for user in connected_users[game.id]:
                if user["websocket"] != websocket:
                    await user["websocket"].send("end game")
            await websocket.send("end game")
            ...
            await websocket.send("draw offer")
            continue
            ...
            await websocket.send("Odrzucono")
            continue
            ...
            try:
                ...
                await websocket.send("made ruch")
